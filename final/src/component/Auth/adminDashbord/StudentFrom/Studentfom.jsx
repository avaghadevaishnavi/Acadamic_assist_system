...
function Studentfom() {
  ...
  const addData = async (e) => {
    ...
    // Validate GR number (should be exactly 3 characters)
    if (grnumber.length !== 3) {
      alert("GR Number should be exactly 3 characters.");
      return;
    }
    ...
    if (!isValidMobile(parentMobileNo)) {
      alert("Please enter a valid 10-digit Parent Mobile Number.");
      return;
    }
  
    if (!isValidMobile(emergencyMobileNo)) {
